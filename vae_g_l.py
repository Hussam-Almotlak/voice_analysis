...
class VAE(nn.Module):
    ...
    def forward(self, input, annealing=0):
        ...
        medium_out = self.medium(input, encoder_out.local_sample, encoder_out.global_sample)
...
class Encoder(nn.Module):
    ...
    def forward(self, input):
        ...
        medium_input = torch.cat((F.dropout(input, p=0.2, training=True), global_sample), 2)
        ...
        net_4 = net_4.repeat(1, input.size(1)-44*3, 1)
