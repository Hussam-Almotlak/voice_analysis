...
if args.dataset == 'LibriSpeech':
    ...
    train_dataset = OMG_dataset.OMGEmotion('../datasets/OMG_preprocessed/', preprocessed=True, emotion_filter=['happiness','sadness'], split='train')
    print("There are: {} Training samples.".format(len(train_dataset)))
    test_dataset = OMG_dataset.OMGEmotion('../datasets/OMG_preprocessed/', preprocessed=True, emotion_filter=['happiness','sadness'], split='test')
    print("There are: {} testing samples.".format(len(test_dataset)))
    label_dict = {'3': 0, '5': 1}

elif args.dataset == 'Enterface':
    train_dataset = Enterface_dataset.Enterface('../datasets/Enterface_preprocessed/', preprocessed=True, emotion_filter=['happiness','sadness'], split='train')
    print("There are: {} Training samples.".format(len(train_dataset)))
    test_dataset = Enterface_dataset.Enterface('../datasets/Enterface_preprocessed/', preprocessed=True, emotion_filter=['happiness','sadness'], split='test')
    print("There are: {} testing samples.".format(len(test_dataset)))
    label_dict = {'happiness': 0, 'sadness': 1}
